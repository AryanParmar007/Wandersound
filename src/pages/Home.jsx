...
const Home = () => {
  return (
    <>
      ...
      <section>
        <Container>
          <Row>
            ...
            <FeaturedTourList/>
            <div className="more">
              <button className="more__tour">More</button>
            </div>
          </Row>
        </Container>
      </section>
      ...
      {/* ==================== Public Review section start ========================*/}
      <section>
        <Container>
          <Row>
            <Col lg='12'>
              <Subtitle  subtitle={'Users Reviews'}/>
              <h2 className="usersreview__title">What Our Enthusiastic Users Share</h2>
            </Col>
            <Col lg='12'>
              <Usersreview/>
            </Col>
